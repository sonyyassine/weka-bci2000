...
*/
int  Tserial_event::connect (const char *port_arg, int  rate_arg,  int parity_arg,
...
void Tserial_event::OnEvent (unsigned long events)
{
    ...
    if ((events & EV_RING)!=0)
    {
        ...
        {
            if (manager!=0)
                manager((t_uint32) this, SERIAL_RING);
        }
    }
    ...
    if ((events & EV_RLSD)!=0)
    {
        ...
        {
            if (manager!=0)
                manager((t_uint32) this, SERIAL_CD_ON);
        }
        else
        {
            if (manager!=0)
                manager((t_uint32) this, SERIAL_CD_OFF);
        }
    }
}
/* -------------------------------------------------------------------- */

////////////////////////////////////////////////////////////////////
// $Id: bci_dll.cpp 1723 2008-01-16 17:46:33Z mellinger $
...
GetInfo()
{
  ...
  sOut << "Filter name: " << name << '\n'
       ...
       << "from $Id: bci_dll.cpp 1723 2008-01-16 17:46:33Z mellinger $\n"
       << ends;
  return sb->str();
}
...
Preflight( long* ioChannels, long* ioElements, char** ioSignalProperties )
{
  ...
  if( ioSignalProperties != NULL
      ...
      && inputProperties.ReadFromStream( istrstream( *ioSignalProperties ) )
